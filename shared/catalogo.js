...
export const ESG_METRICS = [
  { id: 'incidentes', label: 'Incidentes Ambientales', fullTitle: 'Número de incidentes ambientales notificables (Casos por año)', unit: 'Casos' },
  ...
  { id: 'reforestacion', label: 'Reforestación', fullTitle: 'Número de árboles sembrados en campañas de reforestación (Árboles por año)', unit: 'Árboles' },
  { id: 'inversion', label: 'Inversión Ambiental', fullTitle: 'Monto de inversión de acciones vinculadas al medio ambiente (Millones de dólares por año)', unit: 'Millones de dólares', excelUnit: 'Millones USD' },
]
