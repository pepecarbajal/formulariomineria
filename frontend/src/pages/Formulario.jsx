              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[80vh] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <div className="px-6 py-4 overflow-y-auto text-sm text-zinc-600 leading-relaxed space-y-3 flex-1">
                    <p>En cumplimiento con lo dispuesto por la Ley General de Transparencia y Acceso a la Información Pública, la Ley Federal de Protección a la Propiedad Industrial y la normatividad estatal aplicable en materia de transparencia, la Secretaría de Fomento y Desarrollo Económico informa lo siguiente respecto al tratamiento de la información recabada en este formulario:</p>
                    <p><strong>1. Finalidad.</strong> Los datos operativos, productivos, financieros y de indicadores ESG proporcionados serán utilizados exclusivamente para la integración de la estadística minera estatal y el diseño de política pública en la materia.</p>
                    <p><strong>2. Naturaleza de la información.</strong> La información aquí proporcionada constituye secreto industrial y/o comercial en términos del artículo 163 de la Ley Federal de Protección a la Propiedad Industrial, y información confidencial en términos del artículo 116 de la Ley General de Transparencia y Acceso a la Información Pública, al tratarse de datos cuya divulgación podría representar una ventaja competitiva a favor de terceros o un perjuicio económico para la empresa informante.</p>
                    <p><strong>3. Confidencialidad y acceso restringido.</strong> La información será resguardada bajo medidas de seguridad administrativas, técnicas y físicas, y solo será accesible al personal autorizado de la Secretaría de Fomento y Desarrollo Económico que la requiera para el cumplimiento de las finalidades señaladas. No será compartida con terceros salvo requerimiento de autoridad competente conforme a derecho.</p>
                    <p><strong>4. Publicación de resultados.</strong> Los resultados derivados de esta información se harán públicos únicamente de forma agregada y disociada por sector o región, sin identificar cifras individuales por empresa, unidad minera o subsidiaria, garantizando en todo momento el secreto industrial y comercial de las empresas informantes.</p>
                    <p><strong>5. Vigencia y resguardo.</strong> La información será conservada durante el tiempo necesario para cumplir con la finalidad estadística señalada y con los plazos de conservación documental establecidos por la normatividad archivística aplicable.</p>
                    <p><strong>6. Derechos de la empresa informante.</strong> La empresa podrá solicitar en cualquier momento a la Secretaría de Fomento y Desarrollo Económico la aclaración sobre el uso dado a su información mediante el correo mineria.sefodeco@guerrero.gob.mx o el medio de contacto oficial correspondiente.</p>
                  </div>
