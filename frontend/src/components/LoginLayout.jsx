...
export default function LoginLayout({ children }) {
  ...
  return (
    <main className="relative flex min-h-screen overflow-hidden selection:bg-guinda selection:text-white">
      {/* LEFT SIDE - Carousel */}
      ...
      <div className="relative w-full lg:w-[480px] xl:w-[520px] flex items-center justify-center bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 px-6 py-10">
        ...
        <header className="absolute top-0 left-0 right-0 px-6 md:px-8 py-6 flex items-center justify-center">
          <div className="flex items-center gap-4">
            <img src="/1.png" alt="Gobierno del Estado de Guerrero" className="h-14 sm:h-16 object-contain drop-shadow-lg" />
            <div className="w-px h-10 bg-white/20" />
            <img src="/2.png" alt="SEFODECO" className="h-14 sm:h-16 w-auto object-contain drop-shadow-lg" />
          </div>
